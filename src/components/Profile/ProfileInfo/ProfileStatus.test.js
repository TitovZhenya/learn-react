/**
 * !Work only with classes components - deactivateEditMode, getInstance
 * ? Check how it works with functions component and hooks
 */
...
describe("ProfileStatus component", () => {
    ...
    test("after creation <span> should contains correct status", () => {
        ...
        expect(span.children[0]).toBe("use this status");
    });
